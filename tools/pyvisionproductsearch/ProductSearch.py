...
class ProductSearch:
    ...
    class Product:
        ...
        def addReferenceImage(self, filename, bounding_polys=None):
            ...
            # gcs_uri = os.path.join("gs://", bucket.name, blob.name) This is kept breaking on my Windows machine because path was inserting a backslash into a uri
            ...
            res = search.productClient.create_reference_image(
                parent=productPath, reference_image=reference_image,
